        ...
        return (
            <Container>
                 <ImageBackground style={{ width: '100%', height: '100%', flex: 1 }}
                    source={{uri : 'https://images.unsplash.com/photo-1519147683487-66e0c2d0b5a0?ixlib=rb-0.3.5&ixid=eyJhcHBfaWQiOjEyMDd9&s=33757cd9aa1ff5ebdcfa82beefcf4213&auto=format&fit=crop&w=2550&q=80'}}>
                    <Header style={{}}>
                        <Left>

                        </Left>
                        <Body>
                            <Title>donutstore</Title>
                        </Body>
                        <Right>
                    ...
                    <View style={styles.header}>
                        <View style={styles.headerContent}>
                            ...
                            <Text style={styles.name}>donut</Text>
                            <Text style={styles.userInfo}>donut@mail.com </Text>
